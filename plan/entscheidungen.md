...
## Noch offen (geparkt, siehe claude-fragen-v6/-v9)
- **v9-O1…O5** One Call 4.0: `current`-Ist-Wetter, tiefere Pagination + Call-Budget-Schutz, Unwetter-Alerts, mehrere Timelines ans LLM, historische Daten — siehe [../claude-fragen/claude-fragen-v9.md](../claude-fragen/claude-fragen-v9.md). **(v8-W1/W2/W3 erledigt → D-043/D-044; W4–W6 bestätigt.)**
