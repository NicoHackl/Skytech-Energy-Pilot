...
## Noch offen (geparkt, siehe claude-fragen-v7/-v8)
- **v8-W1…W6** Wetter: KI-Kontext-Einspeisung, Zeitraster, Defaults, Koordinatenquelle, Felder, spätere HA-Sensor/HEMS-Bereitstellung — siehe [../claude-fragen/claude-fragen-v8.md](../claude-fragen/claude-fragen-v8.md).
