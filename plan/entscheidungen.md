...
- **v8-W2…W6** Wetter: Zeitraster, Defaults, Koordinatenquelle, Felder, spätere HA-Sensor/HEMS-Bereitstellung — siehe [../claude-fragen/claude-fragen-v8.md](../claude-fragen/claude-fragen-v8.md). **(W1 erledigt → D-043.)**
