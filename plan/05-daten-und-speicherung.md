...
device_extras(device_name, read_entity_id, ai_suggestion, ai_hint, label, unit, sort_order)  -- Zusatz-Entitäten je Gerät (D-047), Migration 6; Typ/Attribute (min/max, has_date/has_time) folgen zur Laufzeit der Domäne (D-048)
