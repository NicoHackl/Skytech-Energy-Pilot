...
| `/geraete` | Geräte | Geräteauswahl, `ems_*`-Werte, Zusatz-Entitäten, KI-Beschreibung, Modus |
| `/prognose` | Prognose | PV-Prognose je Ausrichtung, Wetter |
| `/ziele` | Grenzen & Ziele | abgeleitete harte Grenzen, user-definierte Ziele (D-055) |
| `/plan` | Plan | Planungslauf, Klassifizierung, Prompts, Ergebnis, Schreib-Ergebnis |
