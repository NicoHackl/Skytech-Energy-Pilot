...
- Committen/pushen **nur** in Branch `claude/main` — auch im separaten
  SkytechHEMS-Repo (D-022). Nach **jeder** relevanten Änderung committen/pushen.
- CI (`.github/workflows/ci.yaml`) läuft **nur** auf `claude/main`: Ruff-Lint +
